...
{
    public class DishFilterViewModel: BaseViewModel
    {
        ...
        {
            Reset();
            var globalFilter = ((Excalibur.Views.App)Application.Current).GetDishFilter();
        ...
        public ICommand ResetFilter
        {
            get
            {
                ...
                {
                    Reset();
                    ((Excalibur.Views.App)Application.Current).ResetDishFilter();
                });
            }
        }
        ...
        public ICommand SetFilter
        {
            get
            {
                return new MvxCommand(async () =>
                {                    
                    ((Excalibur.Views.App)Application.Current).SetDishFilter(GetFilter());
